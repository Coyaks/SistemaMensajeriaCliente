...
//    static ServerSocket ss;//clase serverSocket
    ...
    public VistaCliente() {
        ...
        setTitle("Sistema de chat cliente");
        this.setIconImage(new ImageIcon(getClass().getResource("/Imagen/Cliente.png")).getImage());
    }
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        try {
            ...
            String newMensaje=txtTexto.getText().trim();
    ...
    public static void main(String args[]) {
        ...
        String mensaje="";
        try {
            s = new Socket("192.168.1.2",4444);//poner ip del servidor(maquina al cual nos vamos a conectar)
